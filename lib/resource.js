...
Resource.prototype.create = function(){
  ...
  collection.create(data, {
    error: function(model){
      app.log.error('resource: create: ' + name + ':', {model: model, err: new Error()})
...
Resource.prototype.update = function(rawId){
  ...
  model.set(data, {silent: true}).save(null, {
    error: function(modelUpdated){
      app.log.error('resource: update: ' + name + ':', {model: id, err: new Error()})
      this.res.writeHead(500)
...
Resource.prototype.del = function(rawId){
  ...
  model.destroy({
    error: function(modelUpdated){
      app.log.error('resource: ' + name + ':', {model: id, err: new Error()})
      this.res.writeHead(500)
