...
Resource.prototype.init = function(collection, options, callback){
  ...
  app.router.get(path.join('/', this.collection.url, '/:model'), this.read)
  app.router.post(path.join('/', this.collection.url), this.create)
  app.router.put(path.join('/', this.collection.url, '/:model'), this.update)
  app.router['delete'](path.join('/', this.collection.url, '/:model'), this.del)
  this.sse()
